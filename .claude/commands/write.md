---
name: write
description: Create content (blog posts, documentation, reports) with prompt-chained workflow and Ghost publishing
---

# /write - Content Creation

Create Intelligence Adjacent content with prompt-chained workflow enforcement.
...
**You MUST:**
1. Load `commands/write/00-WORKFLOW.md` to determine current phase
...
**Prompts:** `commands/write/prompts/01-05-*.md`
...
```bash
python skills/diagram-generation/scripts/export-diagram.py blog/posts/YYYY-MM-DD-title/diagrams/*.mmd
```
...
```bash
python tools/image-generation/generate_image.py "custom prompt here" -o blog/posts/YYYY-MM-DD-title/hero.png
```
...
**Creates:** `blog/posts/YYYY-MM-DD-title/tweet.txt`
...
```
blog/posts/2025-12-17-post-title/
...
```
blog/posts/2025-12-17-post/  (files never move)
...
4. Files stay in blog/posts/YYYY-MM-DD-title/
...
python tools/image-generation/generate_image.py --hero blog/posts/2025-12-17-title

# Generate hero with custom prompt
python tools/image-generation/generate_image.py "custom prompt" -o blog/posts/2025-12-17-title/hero.png
...
python skills/diagram-generation/scripts/export-diagram.py blog/posts/2025-12-17-title/diagrams/*.mmd
...
→ Publish (files stay in blog/posts/2025-12-17-vps-api-wrappers/)
→ Generate tweet
```
